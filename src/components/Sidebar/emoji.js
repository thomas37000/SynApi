const EMOJIS = [
  ...
  { emoji: '😗', description: 'kissing face', aliases: ['kissing'], tags: [] },
  {
    emoji: '😙',
  ...
  { emoji: '😳', description: 'flushed face', aliases: ['flushed'], tags: [] },
  {
    emoji: '😁',
  ...
  { emoji: '😔', description: 'pensive face', aliases: ['pensive'], tags: [] },
  {
    emoji: '😌',
  ...
  { emoji: '😵', description: 'dizzy face', aliases: ['dizzy_face'], tags: [] },
  {
    emoji: '😲',
  ...
  { emoji: '💂', description: 'guardsman', aliases: ['guardsman'], tags: [] },
  {
    emoji: '👶',
    description: 'baby',
    aliases: ['baby'],
  ...
  { emoji: '👦', description: 'boy', aliases: ['boy'], tags: ['child'] },
  { emoji: '👧', description: 'girl', aliases: ['girl'], tags: ['child'] },
  {
    emoji: '👨',
    description: 'man',
    aliases: ['man'],
  ...
  { emoji: '👩', description: 'woman', aliases: ['woman'], tags: ['girls'] },
  { emoji: '👴', description: 'older man', aliases: ['older_man'], tags: [] },
  {
    emoji: '👵',
  ...
  { emoji: '👼', description: 'baby angel', aliases: ['angel'], tags: [] },
  {
    emoji: '👸',
  ...
  { emoji: '👃', description: 'nose', aliases: ['nose'], tags: ['smell'] },
  { emoji: '👅', description: 'tongue', aliases: ['tongue'], tags: ['taste'] },
  { emoji: '👄', description: 'mouth', aliases: ['lips'], tags: ['kiss'] },
  {
    emoji: '👍',
  ...
  { emoji: '👌', description: 'ok hand sign', aliases: ['ok_hand'], tags: [] },
  {
    emoji: '👊',
  ...
  { emoji: '🚶', description: 'pedestrian', aliases: ['walking'], tags: [] },
  {
    emoji: '🏃',
    description: 'runner',
  ...
  { emoji: '💃', description: 'dancer', aliases: ['dancer'], tags: ['dress'] },
  {
    emoji: '👫',
  ...
  { emoji: '💏', description: 'kiss', aliases: ['couplekiss'], tags: [] },
  {
    emoji: '💑',
  ...
  { emoji: '👒', description: 'womans hat', aliases: ['womans_hat'], tags: [] },
  {
    emoji: '👟',
  ...
  { emoji: '👢', description: 'womans boots', aliases: ['boot'], tags: [] },
  {
    emoji: '👕',
    description: 't-shirt',
  ...
  { emoji: '👗', description: 'dress', aliases: ['dress'], tags: [] },
  {
    emoji: '🎽',
  ...
  { emoji: '👖', description: 'jeans', aliases: ['jeans'], tags: ['pants'] },
  { emoji: '👘', description: 'kimono', aliases: ['kimono'], tags: [] },
  { emoji: '👙', description: 'bikini', aliases: ['bikini'], tags: ['beach'] },
  {
    emoji: '💼',
  ...
  { emoji: '👜', description: 'handbag', aliases: ['handbag'], tags: ['bag'] },
  { emoji: '👝', description: 'pouch', aliases: ['pouch'], tags: ['bag'] },
  { emoji: '👛', description: 'purse', aliases: ['purse'], tags: [] },
  {
    emoji: '👓',
  ...
  { emoji: '🎀', description: 'ribbon', aliases: ['ribbon'], tags: [] },
  {
    emoji: '🌂',
  ...
  { emoji: '💙', description: 'blue heart', aliases: ['blue_heart'], tags: [] },
  {
    emoji: '💜',
  ...
  { emoji: '💕', description: 'two hearts', aliases: ['two_hearts'], tags: [] },
  {
    emoji: '💖',
  ...
  { emoji: '🐶', description: 'dog face', aliases: ['dog'], tags: ['pet'] },
  { emoji: '🐺', description: 'wolf face', aliases: ['wolf'], tags: [] },
  { emoji: '🐱', description: 'cat face', aliases: ['cat'], tags: ['pet'] },
  { emoji: '🐭', description: 'mouse face', aliases: ['mouse'], tags: [] },
  {
    emoji: '🐹',
  ...
  { emoji: '🐸', description: 'frog face', aliases: ['frog'], tags: [] },
  { emoji: '🐯', description: 'tiger face', aliases: ['tiger'], tags: [] },
  { emoji: '🐨', description: 'koala', aliases: ['koala'], tags: [] },
  { emoji: '🐻', description: 'bear face', aliases: ['bear'], tags: [] },
  { emoji: '🐷', description: 'pig face', aliases: ['pig'], tags: [] },
  { emoji: '🐽', description: 'pig nose', aliases: ['pig_nose'], tags: [] },
  { emoji: '🐮', description: 'cow face', aliases: ['cow'], tags: [] },
  { emoji: '🐗', description: 'boar', aliases: ['boar'], tags: [] },
  {
    emoji: '🐵',
  ...
  { emoji: '🐒', description: 'monkey', aliases: ['monkey'], tags: [] },
  { emoji: '🐴', description: 'horse face', aliases: ['horse'], tags: [] },
  { emoji: '🐑', description: 'sheep', aliases: ['sheep'], tags: [] },
  { emoji: '🐘', description: 'elephant', aliases: ['elephant'], tags: [] },
  { emoji: '🐼', description: 'panda face', aliases: ['panda_face'], tags: [] },
  { emoji: '🐧', description: 'penguin', aliases: ['penguin'], tags: [] },
  { emoji: '🐦', description: 'bird', aliases: ['bird'], tags: [] },
  { emoji: '🐤', description: 'baby chick', aliases: ['baby_chick'], tags: [] },
  {
    emoji: '🐥',
  ...
  { emoji: '🐔', description: 'chicken', aliases: ['chicken'], tags: [] },
  { emoji: '🐍', description: 'snake', aliases: ['snake'], tags: [] },
  { emoji: '🐢', description: 'turtle', aliases: ['turtle'], tags: ['slow'] },
  { emoji: '🐛', description: 'bug', aliases: ['bug'], tags: [] },
  {
    emoji: '🐝',
  ...
  { emoji: '🐜', description: 'ant', aliases: ['ant'], tags: [] },
  {
    emoji: '🐞',
  ...
  { emoji: '🐌', description: 'snail', aliases: ['snail'], tags: ['slow'] },
  { emoji: '🐙', description: 'octopus', aliases: ['octopus'], tags: [] },
  {
    emoji: '🐚',
  ...
  { emoji: '🐟', description: 'fish', aliases: ['fish'], tags: [] },
  {
    emoji: '🐬',
    description: 'dolphin',
  ...
  { emoji: '🐋', description: 'whale', aliases: ['whale2'], tags: [] },
  { emoji: '🐄', description: 'cow', aliases: ['cow2'], tags: [] },
  { emoji: '🐏', description: 'ram', aliases: ['ram'], tags: [] },
  { emoji: '🐀', description: 'rat', aliases: ['rat'], tags: [] },
  {
    emoji: '🐃',
  ...
  { emoji: '🐅', description: 'tiger', aliases: ['tiger2'], tags: [] },
  { emoji: '🐇', description: 'rabbit', aliases: ['rabbit2'], tags: [] },
  { emoji: '🐉', description: 'dragon', aliases: ['dragon'], tags: [] },
  {
    emoji: '🐎',
    description: 'horse',
    aliases: ['racehorse'],
  ...
  { emoji: '🐐', description: 'goat', aliases: ['goat'], tags: [] },
  { emoji: '🐓', description: 'rooster', aliases: ['rooster'], tags: [] },
  { emoji: '🐕', description: 'dog', aliases: ['dog2'], tags: [] },
  { emoji: '🐖', description: 'pig', aliases: ['pig2'], tags: [] },
  { emoji: '🐁', description: 'mouse', aliases: ['mouse2'], tags: [] },
  { emoji: '🐂', description: 'ox', aliases: ['ox'], tags: [] },
  {
    emoji: '🐲',
  ...
  { emoji: '🐡', description: 'blowfish', aliases: ['blowfish'], tags: [] },
  { emoji: '🐊', description: 'crocodile', aliases: ['crocodile'], tags: [] },
  { emoji: '🐫', description: 'bactrian camel', aliases: ['camel'], tags: [] },
  {
    emoji: '🐪',
  ...
  { emoji: '🐆', description: 'leopard', aliases: ['leopard'], tags: [] },
  { emoji: '🐈', description: 'cat', aliases: ['cat2'], tags: [] },
  { emoji: '🐩', description: 'poodle', aliases: ['poodle'], tags: ['dog'] },
  {
    emoji: '🐾',
  ...
  { emoji: '🌷', description: 'tulip', aliases: ['tulip'], tags: ['flower'] },
  {
    emoji: '🍀',
  ...
  { emoji: '🌹', description: 'rose', aliases: ['rose'], tags: ['flower'] },
  { emoji: '🌻', description: 'sunflower', aliases: ['sunflower'], tags: [] },
  { emoji: '🌺', description: 'hibiscus', aliases: ['hibiscus'], tags: [] },
  {
    emoji: '🍁',
  ...
  { emoji: '🌿', description: 'herb', aliases: ['herb'], tags: [] },
  {
    emoji: '🌾',
  ...
  { emoji: '🍄', description: 'mushroom', aliases: ['mushroom'], tags: [] },
  { emoji: '🌵', description: 'cactus', aliases: ['cactus'], tags: [] },
  { emoji: '🌴', description: 'palm tree', aliases: ['palm_tree'], tags: [] },
  {
    emoji: '🌲',
  ...
  { emoji: '🌰', description: 'chestnut', aliases: ['chestnut'], tags: [] },
  {
    emoji: '🌱',
  ...
  { emoji: '🌼', description: 'blossom', aliases: ['blossom'], tags: [] },
  {
    emoji: '🌐',
  ...
  { emoji: '🌋', description: 'volcano', aliases: ['volcano'], tags: [] },
  { emoji: '🌌', description: 'milky way', aliases: ['milky_way'], tags: [] },
  { emoji: '🌠', description: 'shooting star', aliases: ['stars'], tags: [] },
  {
    emoji: '⭐',
  ...
  { emoji: '☁️', description: 'cloud', aliases: ['cloud'], tags: [] },
  {
    emoji: '⚡',
  ...
  { emoji: '🌁', description: 'foggy', aliases: ['foggy'], tags: ['karl'] },
  {
    emoji: '🌈',
    description: 'rainbow',
    aliases: ['rainbow'],
  ...
  { emoji: '🎎', description: 'japanese dolls', aliases: ['dolls'], tags: [] },
  {
    emoji: '🎒',
  ...
  { emoji: '🎏', description: 'carp streamer', aliases: ['flags'], tags: [] },
  {
    emoji: '🎆',
  ...
  { emoji: '🎐', description: 'wind chime', aliases: ['wind_chime'], tags: [] },
  {
    emoji: '🎑',
  ...
  { emoji: '📷', description: 'camera', aliases: ['camera'], tags: ['photo'] },
  {
    emoji: '📹',
  ...
  { emoji: '📼', description: 'videocassette', aliases: ['vhs'], tags: [] },
  { emoji: '💿', description: 'optical disc', aliases: ['cd'], tags: [] },
  { emoji: '📀', description: 'dvd', aliases: ['dvd'], tags: [] },
  { emoji: '💽', description: 'minidisc', aliases: ['minidisc'], tags: [] },
  {
    emoji: '💾',
  ...
  { emoji: '📟', description: 'pager', aliases: ['pager'], tags: [] },
  { emoji: '📠', description: 'fax machine', aliases: ['fax'], tags: [] },
  {
    emoji: '📡',
  ...
  { emoji: '📺', description: 'television', aliases: ['tv'], tags: [] },
  { emoji: '📻', description: 'radio', aliases: ['radio'], tags: ['podcast'] },
  {
    emoji: '🔊',
  ...
  { emoji: '🔈', description: 'speaker', aliases: ['speaker'], tags: [] },
  {
    emoji: '🔇',
  ...
  { emoji: '⌚', description: 'watch', aliases: ['watch'], tags: ['time'] },
  {
    emoji: '🔓',
  ...
  { emoji: '🛁', description: 'bathtub', aliases: ['bathtub'], tags: [] },
  { emoji: '🛀', description: 'bath', aliases: ['bath'], tags: ['shower'] },
  { emoji: '🚿', description: 'shower', aliases: ['shower'], tags: ['bath'] },
  { emoji: '🚽', description: 'toilet', aliases: ['toilet'], tags: ['wc'] },
  { emoji: '🔧', description: 'wrench', aliases: ['wrench'], tags: ['tool'] },
  {
    emoji: '🔩',
  ...
  { emoji: '🔨', description: 'hammer', aliases: ['hammer'], tags: ['tool'] },
  { emoji: '🚪', description: 'door', aliases: ['door'], tags: [] },
  {
    emoji: '🚬',
  ...
  { emoji: '💣', description: 'bomb', aliases: ['bomb'], tags: ['boom'] },
  {
    emoji: '🔫',
    description: 'pistol',
    aliases: ['gun'],
  ...
  { emoji: '📧', description: 'e-mail symbol', aliases: ['e-mail'], tags: [] },
  { emoji: '📥', description: 'inbox tray', aliases: ['inbox_tray'], tags: [] },
  {
    emoji: '📤',
  ...
  { emoji: '📮', description: 'postbox', aliases: ['postbox'], tags: [] },
  {
    emoji: '📦',
    description: 'package',
    aliases: ['package'],
  ...
  { emoji: '📋', description: 'clipboard', aliases: ['clipboard'], tags: [] },
  {
    emoji: '📅',
  ...
  { emoji: '📇', description: 'card index', aliases: ['card_index'], tags: [] },
  {
    emoji: '📁',
  ...
  { emoji: '📎', description: 'paperclip', aliases: ['paperclip'], tags: [] },
  { emoji: '✒️', description: 'black nib', aliases: ['black_nib'], tags: [] },
  ...
  { emoji: '📗', description: 'green book', aliases: ['green_book'], tags: [] },
  { emoji: '📘', description: 'blue book', aliases: ['blue_book'], tags: [] },
  {
    emoji: '📙',
  ...
  { emoji: '📒', description: 'ledger', aliases: ['ledger'], tags: [] },
  ...
  { emoji: '🔖', description: 'bookmark', aliases: ['bookmark'], tags: [] },
  { emoji: '📛', description: 'name badge', aliases: ['name_badge'], tags: [] },
  {
    emoji: '🔬',
  ...
  { emoji: '🔭', description: 'telescope', aliases: ['telescope'], tags: [] },
  {
    emoji: '📰',
  ...
  { emoji: '🎳', description: 'bowling', aliases: ['bowling'], tags: [] },
  { emoji: '⛳', description: 'flag in hole', aliases: ['golf'], tags: [] },
  {
    emoji: '🚵',
  ...
  { emoji: '🚴', description: 'bicyclist', aliases: ['bicyclist'], tags: [] },
  {
    emoji: '🏁',
  ...
  { emoji: '🎿', description: 'ski and ski boot', aliases: ['ski'], tags: [] },
  {
    emoji: '🏂',
  ...
  { emoji: '🏊', description: 'swimmer', aliases: ['swimmer'], tags: [] },
  { emoji: '🏄', description: 'surfer', aliases: ['surfer'], tags: [] },
  {
    emoji: '🎣',
  ...
  { emoji: '🍺', description: 'beer mug', aliases: ['beer'], tags: ['drink'] },
  {
    emoji: '🍻',
  ...
  { emoji: '🍷', description: 'wine glass', aliases: ['wine_glass'], tags: [] },
  {
    emoji: '🍴',
  ...
  { emoji: '🍛', description: 'curry and rice', aliases: ['curry'], tags: [] },
  {
    emoji: '🍤',
  ...
  { emoji: '🍣', description: 'sushi', aliases: ['sushi'], tags: [] },
  {
    emoji: '🍥',
  ...
  { emoji: '🍙', description: 'rice ball', aliases: ['rice_ball'], tags: [] },
  {
    emoji: '🍘',
  ...
  { emoji: '🍚', description: 'cooked rice', aliases: ['rice'], tags: [] },
  {
    emoji: '🍜',
  ...
  { emoji: '🍲', description: 'pot of food', aliases: ['stew'], tags: [] },
  { emoji: '🍢', description: 'oden', aliases: ['oden'], tags: [] },
  { emoji: '🍡', description: 'dango', aliases: ['dango'], tags: [] },
  {
    emoji: '🍳',
    description: 'cooking',
    aliases: ['egg'],
  ...
  { emoji: '🍬', description: 'candy', aliases: ['candy'], tags: ['sweet'] },
  { emoji: '🍭', description: 'lollipop', aliases: ['lollipop'], tags: [] },
  { emoji: '🍯', description: 'honey pot', aliases: ['honey_pot'], tags: [] },
  ...
  { emoji: '🍋', description: 'lemon', aliases: ['lemon'], tags: [] },
  {
    emoji: '🍒',
  ...
  { emoji: '🍑', description: 'peach', aliases: ['peach'], tags: [] },
  { emoji: '🍈', description: 'melon', aliases: ['melon'], tags: [] },
  { emoji: '🍌', description: 'banana', aliases: ['banana'], tags: ['fruit'] },
  ...
  { emoji: '🍅', description: 'tomato', aliases: ['tomato'], tags: [] },
  { emoji: '🌽', description: 'ear of maize', aliases: ['corn'], tags: [] },
  { emoji: '🏠', description: 'house building', aliases: ['house'], tags: [] },
  {
    emoji: '🏡',
  ...
  { emoji: '🏫', description: 'school', aliases: ['school'], tags: [] },
  {
    emoji: '🏢',
  ...
  { emoji: '🏥', description: 'hospital', aliases: ['hospital'], tags: [] },
  { emoji: '🏦', description: 'bank', aliases: ['bank'], tags: [] },
  {
    emoji: '🏪',
  ...
  { emoji: '🏩', description: 'love hotel', aliases: ['love_hotel'], tags: [] },
  { emoji: '🏨', description: 'hotel', aliases: ['hotel'], tags: [] },
  {
    emoji: '💒',
    description: 'wedding',
    aliases: ['wedding'],
  ...
  { emoji: '⛪', description: 'church', aliases: ['church'], tags: [] },
  {
    emoji: '🏬',
  ...
  { emoji: '⛺', description: 'tent', aliases: ['tent'], tags: ['camping'] },
  { emoji: '🏭', description: 'factory', aliases: ['factory'], tags: [] },
  {
    emoji: '🗼',
  ...
  { emoji: '🗻', description: 'mount fuji', aliases: ['mount_fuji'], tags: [] },
  {
    emoji: '🌄',
  ...
  { emoji: '🌅', description: 'sunrise', aliases: ['sunrise'], tags: [] },
  {
    emoji: '🌃',
  ...
  { emoji: '⛲', description: 'fountain', aliases: ['fountain'], tags: [] },
  {
    emoji: '🎢',
  ...
  { emoji: '🚢', description: 'ship', aliases: ['ship'], tags: [] },
  {
    emoji: '⛵',
  ...
  { emoji: '🚣', description: 'rowboat', aliases: ['rowboat'], tags: [] },
  { emoji: '⚓', description: 'anchor', aliases: ['anchor'], tags: ['ship'] },
  {
    emoji: '🚀',
    description: 'rocket',
    aliases: ['rocket'],
  ...
  { emoji: '💺', description: 'seat', aliases: ['seat'], tags: [] },
  { emoji: '🚁', description: 'helicopter', aliases: ['helicopter'], tags: [] },
  {
    emoji: '🚂',
  ...
  { emoji: '🚊', description: 'tram', aliases: ['tram'], tags: [] },
  { emoji: '🚉', description: 'station', aliases: ['station'], tags: [] },
  {
    emoji: '🚞',
  ...
  { emoji: '🚆', description: 'train', aliases: ['train2'], tags: [] },
  {
    emoji: '🚄',
  ...
  { emoji: '🚈', description: 'light rail', aliases: ['light_rail'], tags: [] },
  { emoji: '🚇', description: 'metro', aliases: ['metro'], tags: [] },
  { emoji: '🚝', description: 'monorail', aliases: ['monorail'], tags: [] },
  { emoji: '🚋', description: 'tram car', aliases: ['train'], tags: [] },
  {
    emoji: '🚃',
  ...
  { emoji: '🚎', description: 'trolleybus', aliases: ['trolleybus'], tags: [] },
  { emoji: '🚌', description: 'bus', aliases: ['bus'], tags: [] },
  {
    emoji: '🚍',
  ...
  { emoji: '🚕', description: 'taxi', aliases: ['taxi'], tags: [] },
  {
    emoji: '🚖',
  ...
  { emoji: '🚚', description: 'delivery truck', aliases: ['truck'], tags: [] },
  {
    emoji: '🚨',
  ...
  { emoji: '🚓', description: 'police car', aliases: ['police_car'], tags: [] },
  {
    emoji: '🚔',
  ...
  { emoji: '🚑', description: 'ambulance', aliases: ['ambulance'], tags: [] },
  { emoji: '🚐', description: 'minibus', aliases: ['minibus'], tags: [] },
  { emoji: '🚲', description: 'bicycle', aliases: ['bike'], tags: ['bicycle'] },
  {
    emoji: '🚡',
  ...
  { emoji: '🚜', description: 'tractor', aliases: ['tractor'], tags: [] },
  { emoji: '💈', description: 'barber pole', aliases: ['barber'], tags: [] },
  { emoji: '🚏', description: 'bus stop', aliases: ['busstop'], tags: [] },
  { emoji: '🎫', description: 'ticket', aliases: ['ticket'], tags: [] },
  {
    emoji: '🚦',
  ...
  { emoji: '⛽', description: 'fuel pump', aliases: ['fuelpump'], tags: [] },
  {
    emoji: '🏮',
  ...
  { emoji: '🗿', description: 'moyai', aliases: ['moyai'], tags: ['stone'] },
  {
    emoji: '🎪',
  ...
  { emoji: '🔟', description: 'keycap ten', aliases: ['keycap_ten'], tags: [] },
  {
    emoji: '🔢',
  ...
  { emoji: '🆗', description: 'squared ok', aliases: ['ok'], tags: ['yes'] },
  {
    emoji: '🔀',
  ...
  { emoji: '🆒', description: 'squared cool', aliases: ['cool'], tags: [] },
  { emoji: '🆓', description: 'squared free', aliases: ['free'], tags: [] },
  { emoji: '🆖', description: 'squared ng', aliases: ['ng'], tags: [] },
  {
    emoji: '📶',
  ...
  { emoji: '🚹', description: 'mens symbol', aliases: ['mens'], tags: [] },
  { emoji: '🚺', description: 'womens symbol', aliases: ['womens'], tags: [] },
  {
    emoji: '🚼',
  ...
  { emoji: '🛃', description: 'customs', aliases: ['customs'], tags: [] },
  {
    emoji: '🉑',
  ...
  { emoji: '🆑', description: 'squared cl', aliases: ['cl'], tags: [] },
  {
    emoji: '🆘',
  ...
  { emoji: '🆔', description: 'squared id', aliases: ['id'], tags: [] },
  {
    emoji: '🚫',
  ...
  { emoji: '❇️', description: 'sparkle', aliases: ['sparkle'], tags: [] },
  {
    emoji: '❎',
  ...
  { emoji: '🆚', description: 'squared vs', aliases: ['vs'], tags: [] },
  {
    emoji: '📳',
  ...
  { emoji: '♈', description: 'aries', aliases: ['aries'], tags: [] },
  { emoji: '♉', description: 'taurus', aliases: ['taurus'], tags: [] },
  { emoji: '♊', description: 'gemini', aliases: ['gemini'], tags: [] },
  { emoji: '♋', description: 'cancer', aliases: ['cancer'], tags: [] },
  { emoji: '♌', description: 'leo', aliases: ['leo'], tags: [] },
  { emoji: '♍', description: 'virgo', aliases: ['virgo'], tags: [] },
  { emoji: '♎', description: 'libra', aliases: ['libra'], tags: [] },
  { emoji: '♏', description: 'scorpius', aliases: ['scorpius'], tags: [] },
  {
    emoji: '♐',
  ...
  { emoji: '♑', description: 'capricorn', aliases: ['capricorn'], tags: [] },
  { emoji: '♒', description: 'aquarius', aliases: ['aquarius'], tags: [] },
  { emoji: '♓', description: 'pisces', aliases: ['pisces'], tags: [] },
  { emoji: '⛎', description: 'ophiuchus', aliases: ['ophiuchus'], tags: [] },
  {
    emoji: '🔯',
  ...
  { emoji: '❌', description: 'cross mark', aliases: ['x'], tags: [] },
  {
    emoji: '‼️',
  ...
  { emoji: '⭕', description: 'heavy large circle', aliases: ['o'], tags: [] },
  {
    emoji: '🔝',
  ...
  { emoji: '♣️', description: 'black club suit', aliases: ['clubs'], tags: [] },
  {
    emoji: '♦️',
  ...
  { emoji: '🔗', description: 'link symbol', aliases: ['link'], tags: [] },
  { emoji: '➰', description: 'curly loop', aliases: ['curly_loop'], tags: [] },
  { emoji: '〰️', description: 'wavy dash', aliases: ['wavy_dash'], tags: [] },
  {
    emoji: '〽️',
  ...
  { aliases: ['basecamp'], tags: [] },
  { aliases: ['basecampy'], tags: [] },
  { aliases: ['bowtie'], tags: [] },
  { aliases: ['feelsgood'], tags: [] },
  { aliases: ['finnadie'], tags: [] },
  { aliases: ['fu'], tags: [] },
  { aliases: ['goberserk'], tags: [] },
  { aliases: ['godmode'], tags: [] },
  { aliases: ['hurtrealbad'], tags: [] },
  { aliases: ['metal'], tags: [] },
  { aliases: ['neckbeard'], tags: [] },
  { aliases: ['octocat'], tags: [] },
  { aliases: ['rage1'], tags: [] },
  { aliases: ['rage2'], tags: [] },
  { aliases: ['rage3'], tags: [] },
  { aliases: ['rage4'], tags: [] },
  { aliases: ['shipit', 'squirrel'], tags: [] },
  { aliases: ['suspect'], tags: [] },
  { aliases: ['taco'], tags: [] },
  { aliases: ['trollface'], tags: [] },
];
