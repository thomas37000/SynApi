<?php
	// appeler le fichier php en ajax, il rajoute le token et il appelle l' api, il retourne un json
 ...
 // "ERROR: The url must include a single parameter of the URL to proxy. 
 //  Ex. ...php?https://slideyour.net/api.php'"

 $url = "https://slideyour.net/api.php"
 $pages = file($url);
